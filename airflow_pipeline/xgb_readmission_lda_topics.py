...
def make_one_hot(df):
    ...
    feature_entities = df['lda_ngrams']
...
def make_predictions():
    df_json_encoded = standard_read_from_db('lda_ngrams_column')
    ...
    xgb_write_to_db('lda_xgb_readmission', df_json_encoded, top_n_df_json_encoded, bst_pickle)
