...
class SomeCallableTest(unittest.TestCase):
    ...
    def test_make_one_hot_standard_true_case(self):
        ...
        one_hot = xgb_readmission_feature_entities.make_one_hot(df)
        # print (one_hot)
    ...
    def test_train_xgb_model_not_null(self):
        ...
        xgb_model = xgb_readmission_feature_entities.train_xgb_model(df, one_hot)
        # print (one_hot)
        if (one_hot.empty):
            True
        if (one_hot.all):
    ...
    def test_add_predictions_column_no_null_entries(self):
        ...
        updated_df = xgb_readmission_feature_entities.add_predictions_column(df, xgb_model, one_hot)
        # print (updated_df)
    ...
    def test_make_top_n_features_check_num_features(self):
        ...
        xgb_model = xgb_readmission_feature_entities.train_xgb_model(df, one_hot)
        top_2_df = xgb_readmission_feature_entities.make_top_n_features(xgb_model, one_hot, 2)
        # print (top_2_df)
