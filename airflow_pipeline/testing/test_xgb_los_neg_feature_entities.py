...
class SomeCallableTest(unittest.TestCase):
    ...
    def test_make_one_hot_standard_true_case(self):
        ...
        one_hot = xgb_los_neg_feature_entities.make_one_hot(df)
        # print (one_hot)
    ...
    def test_train_xgb_model_not_null(self):
        df = pd.DataFrame()
        row1 = {'admission_id':1, 'neg_feature_entities':['not_well_seen','no_aortic_regurgitation', 'no_ventricular', 'no_intervention', 'no_pulmonary', 'no_significant_change'], 'los': 5}
        row2 = {'admission_id':2, 'neg_feature_entities':['no_intervention', 'not_well_seen'], 'los': 8}
        row3 = {'admission_id':3, 'neg_feature_entities':['no_significant_change', 'no_pulmonary'], 'los': 9}
        df = df.append(row1, ignore_index=True)
        df = df.append(row2, ignore_index=True)
        df = df.append(row3, ignore_index=True)
        ...
        xgb_model = xgb_los_neg_feature_entities.train_xgb_model(df, one_hot)
        # print (one_hot)
    ...
    def test_add_predictions_column_no_null_entries(self):
        df = pd.DataFrame()
        row1 = {'admission_id':1, 'neg_feature_entities':['not_well_seen','no_aortic_regurgitation', 'no_ventricular', 'no_intervention', 'no_pulmonary', 'no_significant_change'], 'los': 6}
        row2 = {'admission_id':2, 'neg_feature_entities':['no_intervention', 'not_well_seen'], 'los': 6}
        row3 = {'admission_id':3, 'neg_feature_entities':['no_significant_change', 'no_pulmonary'], 'los': 3}
        df = df.append(row1, ignore_index=True)
        df = df.append(row2, ignore_index=True)
        df = df.append(row3, ignore_index=True)
        ...
        updated_df = xgb_los_neg_feature_entities.add_predictions_column(df, xgb_model, one_hot)
        # print (updated_df)
    ...
    def test_make_top_n_features_check_num_features(self):
        df = pd.DataFrame()
        row1 = {'admission_id':1, 'neg_feature_entities':['not_well_seen','no_aortic_regurgitation', 'no_ventricular', 'no_intervention', 'no_pulmonary', 'no_significant_change'], 'los': 7}
        row2 = {'admission_id':2, 'neg_feature_entities':['no_intervention', 'not_well_seen', 'no_drainage', 'no_aortic_regurgitation'], 'los': 3}
        row3 = {'admission_id':3, 'neg_feature_entities':['no_significant_change', 'no_pulmonary'], 'los': 2}
        df = df.append(row1, ignore_index=True)
        df = df.append(row2, ignore_index=True)
        df = df.append(row3, ignore_index=True)
        ...
        xgb_model = xgb_los_neg_feature_entities.train_xgb_model(df, one_hot)
        top_2_df = xgb_los_neg_feature_entities.make_top_n_features(xgb_model, one_hot, 2)
        # print (top_2_df)
